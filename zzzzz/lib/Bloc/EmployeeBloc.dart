...
class EmployeeBloc {
  ...
  //streamController   passed in constructor
...
//these are actually listed as streams in streambuilder, and acess functions---------------
  ...
  _incrementSalaray(Employee employee) {
    ...
    employees[employee.id - 1].salary = newSalary;

    //to update data    or   sink data in stream
